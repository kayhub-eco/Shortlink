...
<html>
	...
	<body>
	    <div class="wrap">
			...
			<div class="footer">
				Program by <a href="https://www.kayhub.com">KayHub Ecological Software</a>, source code is available on <a href="https://github.com/kayhub-eco/Shortlink" title="源码" target="_blank">GitHub</a>.
			</div>
	    </div>
		<!--嵌入 JS 代码-->
		<script>
